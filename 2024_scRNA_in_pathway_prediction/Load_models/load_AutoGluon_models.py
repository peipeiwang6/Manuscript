...
for i in range(0, 100):
    ...
    test_scores = f1_score(y_test, y_pred, average=None)
    f1_scores.append(test_scores)

test_df = pd.DataFrame(f1_scores)
test_df.columns = list(gene_test_multilabel)[1:]
test_name = 'Autogluon_new_test_F1_score.csv'
